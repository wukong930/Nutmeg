...
from nutmeg.recommendations.competition_data_quality_beta_lane_grid import (
    ...
    _beta_lane_prediction_count,
)
from nutmeg.recommendations.competition_data_quality_beta_lane_grid import (
    _baseline_backtest_options as _grid_baseline_backtest_options,
)
from nutmeg.recommendations.competition_data_quality_beta_lane_grid import (
    _candidate_backtest_options as _grid_candidate_backtest_options,
)
...
type HistoricalCompetitionDataQualityBetaLaneRollingAdmissionStatus = Literal[
    "accepted",
    "shadow_only",
    "rejected",
]
type HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheckStatus = Literal[
    "passed",
    "failed",
]
type HistoricalCompetitionDataQualityBetaLaneFoldStatus = Literal[
    "passed",
    "failed",
    "skipped",
]
...
class HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions(BaseModel):
    ...
    require_probability_repair: bool = True
    min_overall_final_answer_count: int = Field(default=30, ge=1)
    min_overall_beta_lane_prediction_count: int = Field(default=1, ge=0)
    min_overall_probability_repair_candidate_count: int = Field(default=1, ge=0)
    min_overall_probability_repair_final_answer_selected_candidate_count: int = Field(
        default=1,
        ge=0,
    )
    ...
    min_fold_beta_lane_prediction_count: int = Field(default=1, ge=0)
    min_fold_probability_repair_candidate_count: int = Field(default=1, ge=0)
    min_fold_probability_repair_final_answer_selected_candidate_count: int = Field(
        default=1,
        ge=0,
    )
...
class HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck(BaseModel):
    name: str
    status: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheckStatus
    actual: float | int | str | bool | None = None
    threshold: float | int | str | bool | None = None
    detail: str


class HistoricalCompetitionDataQualityBetaLaneFold(BaseModel):
    fold_id: str
    fold_type: str
    status: HistoricalCompetitionDataQualityBetaLaneFoldStatus
    ...
    probability_repair_candidate_count: int = Field(ge=0)
    probability_repair_candidate_pool_count: int = Field(ge=0)
    probability_repair_final_answer_selected_candidate_count: int = Field(ge=0)
...
class HistoricalCompetitionDataQualityBetaLaneRollingAdmissionReport(BaseModel):
    report_key: str
    status: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionStatus
    ...
    overall_fold: HistoricalCompetitionDataQualityBetaLaneFold
    ...
    checks: list[HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck] = Field(
        default_factory=list
    )
    folds: list[HistoricalCompetitionDataQualityBetaLaneFold] = Field(
        default_factory=list
    )
...
def load_historical_competition_data_quality_beta_lane_grid_report(
    path: Path | str,
) -> HistoricalCompetitionDataQualityBetaLaneGridReport:
    return HistoricalCompetitionDataQualityBetaLaneGridReport.model_validate_json(
        Path(path).read_text(encoding="utf-8")
    )


def build_historical_competition_data_quality_beta_lane_rolling_admission_report(
    historical_slices: Sequence[HistoricalRecommendationSlice],
    *,
    grid_report: HistoricalCompetitionDataQualityBetaLaneGridReport,
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions | None = None,
) -> HistoricalCompetitionDataQualityBetaLaneRollingAdmissionReport:
    resolved_options = (
        options
        or HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions()
    )
    ...
    warnings = [
        f"competition_data_quality_beta_lane_rolling_admission:failed_check:{check.name}"
        for check in failed_checks
    ]
    summary: dict[str, object] = {
        "calculation_basis": (
            "historical_competition_data_quality_beta_lane_rolling_admission_v3_1"
        ),
        "status": status,
        ...
        "candidate_competition_id": candidate.competition_id,
        ...
        "candidate_beta_min_data_quality_score": candidate.beta_min_data_quality_score,
        "candidate_min_probability": candidate.min_probability,
        "candidate_max_decimal_odds": candidate.max_decimal_odds,
        "candidate_min_model_edge": candidate.min_model_edge,
        "candidate_min_model_confidence_score": (
            candidate.min_model_confidence_score
        ),
        "candidate_min_calibration_score": candidate.min_calibration_score,
        "candidate_min_odds_stability_score": (
            candidate.min_odds_stability_score
        ),
        "candidate_max_volatility_penalty": candidate.max_volatility_penalty,
        "candidate_probability_repair_strength": (
            candidate.probability_repair_strength
        ),
        "candidate_probability_repair_max_delta": (
            candidate.probability_repair_max_delta
        ),
        "candidate_probability_repair_min_market_probability_delta": (
            candidate.probability_repair_min_market_probability_delta
        ),
        "candidate_probability_repair_extra_uplift": (
            candidate.probability_repair_extra_uplift
        ),
        "candidate_probability_repair_data_quality_gap_weight": (
            candidate.probability_repair_data_quality_gap_weight
        ),
        "candidate_probability_repair_odds_stability_weight": (
            candidate.probability_repair_odds_stability_weight
        ),
        "candidate_probability_repair_max_probability": (
            candidate.probability_repair_max_probability
        ),
    ...
    return HistoricalCompetitionDataQualityBetaLaneRollingAdmissionReport(
...
def _options_with_global_competition_season_context(
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions,
    historical_slices: Sequence[HistoricalRecommendationSlice],
) -> HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions:
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    report = build_historical_competition_data_quality_beta_lane_rolling_admission_report(
        loaded_slices.slices,
        grid_report=load_historical_competition_data_quality_beta_lane_grid_report(
            args.grid_report
        ),
...
def _fold_reports(
    ...
    *,
    ...
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions,
) -> list[HistoricalCompetitionDataQualityBetaLaneFold]:
    folds: list[HistoricalCompetitionDataQualityBetaLaneFold] = []
...
def _fold_report(
    ...
    *,
    candidate: HistoricalCompetitionDataQualityBetaLaneCandidate,
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions,
) -> HistoricalCompetitionDataQualityBetaLaneFold:
    baseline_suite = run_historical_recommendation_backtest_suite(
        historical_slices,
        options=_baseline_backtest_options(options),
        baseline_optimizer_profile=options.optimizer_profile,
        candidate_optimizer_profile=options.optimizer_profile,
    )
    candidate_suite = run_historical_recommendation_backtest_suite(
        historical_slices,
        options=_candidate_backtest_options(options, candidate),
        baseline_optimizer_profile=options.optimizer_profile,
        candidate_optimizer_profile=options.optimizer_profile,
    )
    ...
    skipped = (
        ...
        or metrics.beta_lane_prediction_count < options.min_fold_beta_lane_prediction_count
        or metrics.probability_repair_candidate_count
        < options.min_fold_probability_repair_candidate_count
        or metrics.probability_repair_final_answer_selected_candidate_count
        < options.min_fold_probability_repair_final_answer_selected_candidate_count
    )
    status: HistoricalCompetitionDataQualityBetaLaneFoldStatus = (
        "skipped" if skipped else "failed" if failure_reasons else "passed"
    )
    return HistoricalCompetitionDataQualityBetaLaneFold(
        fold_id=fold_id,
        fold_type=fold_type,
        status=status,
        source_slice_ids=[
        ...
        beta_lane_prediction_count=metrics.beta_lane_prediction_count,
        probability_repair_candidate_count=metrics.probability_repair_candidate_count,
        probability_repair_candidate_pool_count=(
            metrics.probability_repair_candidate_pool_count
        ),
        probability_repair_final_answer_selected_candidate_count=(
            metrics.probability_repair_final_answer_selected_candidate_count
        ),
...
def _suite_pair_metrics(
    ...
    *,
    ...
    for slice_id in paired_slice_ids:
        baseline_final = baseline_by_slice[slice_id].final_answer
        candidate_final = candidate_by_slice[slice_id].final_answer
        ...
        if (
            ...
            and baseline_final.actual_hit
            and not candidate_final.actual_hit
        ):
            harm_count += 1
        if (
            baseline_final is not None
            and candidate_final is not None
            and not baseline_final.actual_hit
            and candidate_final.actual_hit
        ):
            improvement_count += 1
    ...
    return _SuitePairMetrics(
        ...
        beta_lane_prediction_count=_fold_beta_lane_prediction_count(
            historical_slices,
            candidate=candidate,
            options=options,
        ),
        probability_repair_candidate_count=_candidate_result_summary_count(
            candidate_suite,
            "data_quality_beta_lane_probability_repair_candidate_count",
        ),
        probability_repair_candidate_pool_count=_candidate_result_summary_count(
            candidate_suite,
            "data_quality_beta_lane_probability_repair_candidate_pool_count",
        ),
        probability_repair_final_answer_selected_candidate_count=(
            _candidate_result_summary_count(
                candidate_suite,
                (
        ...
        harm_count_vs_baseline=harm_count,
...
def _checks(
    ...
    *,
    overall_fold: HistoricalCompetitionDataQualityBetaLaneFold,
    folds: Sequence[HistoricalCompetitionDataQualityBetaLaneFold],
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions,
) -> list[HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck]:
    ...
    return [
        _boolean_check(
            ...
            expected=True,
            detail="source beta-lane grid report must be generated",
        ),
        _boolean_check(
        ...
        _boolean_check(
            name="candidate_probability_repair_enabled",
            actual=_candidate_probability_repair_enabled(candidate),
            expected=True,
            detail="local calibration admission should validate a repair profile",
            enabled=options.require_probability_repair,
        ),
        _minimum_check(
        ...
        _minimum_check(
            name="overall_beta_lane_prediction_count",
            actual=overall_fold.beta_lane_prediction_count,
            threshold=options.min_overall_beta_lane_prediction_count,
            detail="overall admission should exercise the beta lane",
        ),
        _minimum_check(
            name="overall_probability_repair_candidate_count",
            actual=overall_fold.probability_repair_candidate_count,
            threshold=options.min_overall_probability_repair_candidate_count,
            detail="overall admission should apply probability repair",
        ),
        _minimum_check(
            name="overall_probability_repair_final_answer_selected_candidate_count",
            actual=(
                overall_fold.probability_repair_final_answer_selected_candidate_count
            ),
            threshold=(
                options.min_overall_probability_repair_final_answer_selected_candidate_count
            ),
            detail="overall final answer should contain repaired beta-lane candidates",
        ),
        _minimum_check(
...
def _baseline_backtest_options(
    ...
    return _grid_baseline_backtest_options(_grid_options(options))
...
def _candidate_backtest_options(
    ...
    return _grid_candidate_backtest_options(
        _grid_options(options),
        competition_id=candidate.competition_id,
        season_ids=candidate.season_ids,
        ...
        beta_min_data_quality_score=candidate.beta_min_data_quality_score,
        min_probability=candidate.min_probability,
        max_decimal_odds=candidate.max_decimal_odds,
        min_model_edge=candidate.min_model_edge,
        min_model_confidence_score=candidate.min_model_confidence_score,
        min_calibration_score=candidate.min_calibration_score,
        min_odds_stability_score=candidate.min_odds_stability_score,
        max_volatility_penalty=candidate.max_volatility_penalty,
        probability_repair_strength=candidate.probability_repair_strength,
        probability_repair_max_delta=candidate.probability_repair_max_delta,
        probability_repair_min_market_probability_delta=(
            candidate.probability_repair_min_market_probability_delta
        ),
        probability_repair_extra_uplift=candidate.probability_repair_extra_uplift,
        ...
        probability_repair_max_probability=candidate.probability_repair_max_probability,
    )
...
def _grid_options(
    ...
    return HistoricalCompetitionDataQualityBetaLaneGridOptions(
        ...
        baseline_min_data_quality_score=options.baseline_min_data_quality_score,
    )


def _fold_beta_lane_prediction_count(
    historical_slices: Sequence[HistoricalRecommendationSlice],
    *,
    candidate: HistoricalCompetitionDataQualityBetaLaneCandidate,
    options: HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions,
) -> int:
    return _beta_lane_prediction_count(
        historical_slices,
        competition_id=candidate.competition_id,
        season_ids=candidate.season_ids,
        min_competition_season_index=candidate.min_competition_season_index,
...
def _candidate_result_summary_count(
    suite: HistoricalRecommendationBacktestSuiteResult,
    key: str,
) -> int:
    return sum(
        _summary_int(comparison.candidate.summary_json, key)
        for comparison in suite.comparisons
    )


def _candidate_probability_repair_enabled(
    candidate: HistoricalCompetitionDataQualityBetaLaneCandidate,
) -> bool:
    return candidate.probability_repair_max_delta > 0 and any(
        value > 0
        for value in (
            candidate.probability_repair_strength,
            candidate.probability_repair_extra_uplift,
...
def _check_failed(
    checks: Sequence[HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck],
    name: str,
) -> bool:
...
def _boolean_check(
    *,
    ...
    detail: str,
    enabled: bool = True,
) -> HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck:
    if not enabled:
        return HistoricalCompetitionDataQualityBetaLaneRollingAdmissionCheck(
            name=name,
            status="passed",
            actual=None,
...
def _parse_args(argv: Sequence[str] | None = None) -> Namespace:
    parser = ArgumentParser(
        description="Run rolling/holdout admission for beta-lane local calibration."
    )
    parser.add_argument("slice_paths", nargs="*", type=Path)
    parser.add_argument("--suite-manifest", action="append", type=Path)
    ...
    parser.add_argument("--allow-unrepaired-candidate", action="store_true")
    parser.add_argument("--min-overall-final-answer-count", type=int, default=30)
    parser.add_argument("--min-overall-beta-lane-prediction-count", type=int, default=1)
    parser.add_argument(
        "--min-overall-probability-repair-candidate-count",
        type=int,
        default=1,
    )
    parser.add_argument(
        "--min-overall-probability-repair-final-answer-selected-candidate-count",
        type=int,
        default=1,
    )
    ...
    parser.add_argument("--min-fold-beta-lane-prediction-count", type=int, default=1)
    parser.add_argument(
        "--min-fold-probability-repair-candidate-count",
        type=int,
        default=1,
    )
    parser.add_argument(
        "--min-fold-probability-repair-final-answer-selected-candidate-count",
        type=int,
        default=1,
    )
...
def _options_from_args(
    ...
    return HistoricalCompetitionDataQualityBetaLaneRollingAdmissionOptions(
        ...
        require_probability_repair=not args.allow_unrepaired_candidate,
        min_overall_final_answer_count=args.min_overall_final_answer_count,
        min_overall_beta_lane_prediction_count=(
            args.min_overall_beta_lane_prediction_count
        ),
        min_overall_probability_repair_candidate_count=(
            args.min_overall_probability_repair_candidate_count
        ),
        min_overall_probability_repair_final_answer_selected_candidate_count=(
            args.min_overall_probability_repair_final_answer_selected_candidate_count
        ),
        ...
        min_fold_beta_lane_prediction_count=args.min_fold_beta_lane_prediction_count,
        min_fold_probability_repair_candidate_count=(
            args.min_fold_probability_repair_candidate_count
        ),
        min_fold_probability_repair_final_answer_selected_candidate_count=(
            args.min_fold_probability_repair_final_answer_selected_candidate_count
        ),
...
def _report_key(
    ...
    return f"historical_competition_data_quality_beta_lane_rolling_admission:{digest}"
