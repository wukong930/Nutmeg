...
δ₊₁=0.016 需要 N≈3,700(朴素)/ 5,500–7,400(算同日聚类)—— 而竞彩每年只开
约 660 场 +1 线 ⇒ **≈8 年**。**一个这么小的 δ 在实践上不可确立。**
...
_FIT_META: tuple[tuple[str, str, str, int, float, str], ...] = (
    ("−1 让胜", "_C1_DELTA", "_C1_DELTA_SE", 1882, 0.25,
     "handicap_h2_calibration_2026-07-17 (A′/v1.7)"),
    ("+1 让负", "_C1_DELTA_P1", "_C1_DELTA_P1_SE", 1044, 0.38,
     "handicap_h2_calibration_2026-07-17 (A′/v1.7)"),
...
def render_power() -> str:
    ...
    out += [
        ...
        "无效策略**:δ₊₁=0.016 需要 ~3,700(朴素)/ 5,500–7,400(现实),而竞彩每年",
        "只开约 660 场 +1 线 ⇒ **≈8 年**。**一个这么小的 δ 在实践上不可确立** ——",
