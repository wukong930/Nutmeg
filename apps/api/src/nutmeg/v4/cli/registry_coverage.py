...
OUT_OF_SCOPE: dict[str, str] = {
    ...
    # 2026-09-23 补。国家队赛事的「队表」= 会员协会,拿俱乐部式全表去比没有意义。
    "UEFA_NATIONS_LEAGUE": "国家队赛事,队表=欧足联 55 个会员协会",
    "FRIENDLIES":     "国家队友谊赛,无固定参赛表;AF id 10 还混着 U17–U21 青年友谊赛",
    "FAC":            "国内杯赛,参赛队跨多级联赛",
    ...
    "JPN_EMPEROR_CUP": "国内杯赛,参赛队含大学/业余队,无固定赛季队表;Odds API 无 sport key",
