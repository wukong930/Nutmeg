...
_Generated 2026-07-15 05:58 UTC_
...
- Calibration T:    MLE=1.030  GBM=0.816
...
| **V4 GBM-λ + DC + Temp**         | 0.9973 | 0.5960 | 0.5084 | 0.0236 | +0.0031 |
| V4 GBM-λ + DC (raw)              | 0.9978 | 0.5961 | 0.5084 | 0.0174 | +0.0036 |
| V5 XGBoost + DC                  | 0.9968 | 0.5956 | 0.5112 | 0.0147 | +0.0026 |
| **V5 CatBoost + DC**             | 0.9952 | 0.5946 | 0.5103 | 0.0138 | +0.0010 |
| V5 Ensemble (stacker)            | 1.0009 | 0.5980 | 0.5087 | 0.0202 | +0.0067 |
| V5 Ensemble + Temp               | 1.0016 | 0.5984 | 0.5087 | 0.0234 | +0.0074 |
...
**Best model captures 93.6% of available signal** (uniform→Pinnacle gap = 0.1083; best closes 0.1013).

## Per-league breakdown

| League | test_n | Pinnacle | MLE DC | MLE+Temp | GBM-λ+DC | GBM+Temp | GBM Δ |
|--------|-------:|---------:|-------:|---------:|---------:|---------:|------:|
| EPL                      |   380 | 0.9664 | 1.0092 | 1.0081 | 0.9833 | 0.9899 | +0.0235 |
| ESP_LA_LIGA              |   380 | 0.9463 | 0.9900 | 0.9901 | 0.9511 | 0.9422 | -0.0041 |
| ITA_SERIE_A              |   380 | 0.9513 | 0.9815 | 0.9822 | 0.9702 | 0.9665 | +0.0152 |
| GER_BUNDESLIGA           |   306 | 0.9882 | 1.0427 | 1.0407 | 1.0094 | 1.0176 | +0.0294 |
| FRA_LIGUE_1              |   306 | 0.9550 | 1.0038 | 1.0041 | 0.9616 | 0.9599 | +0.0048 |
| ENG_CHAMPIONSHIP         |   552 | 1.0274 | 1.0395 | 1.0393 | 1.0287 | 1.0280 | +0.0006 |
| ESP_SEGUNDA_DIVISION     |   462 | 1.0126 | 1.0541 | 1.0540 | 1.0178 | 1.0117 | -0.0009 |
| ITA_SERIE_B              |   380 | 1.0494 | 1.1232 | 1.1216 | 1.0524 | 1.0507 | +0.0013 |
| GER_2_BUNDESLIGA         |   306 | 1.0604 | 1.0932 | 1.0914 | 1.0708 | 1.0831 | +0.0227 |
| FRA_LIGUE_2              |   306 | 1.0147 | 1.0741 | 1.0735 | 1.0255 | 1.0239 | +0.0093 |
| NED_EREDIVISIE           |   306 | 0.9376 | 1.0148 | 1.0116 | 0.9456 | 0.9475 | +0.0100 |
| PRT_PRIMEIRA_LIGA        |   306 | 0.9239 | 0.9942 | 0.9931 | 0.9321 | 0.9251 | +0.0012 |
